...
const lineRectCollide = (line, rect) => {
	if (line.y != null)
...
// Export to node.js and ES6 modules
if (typeof (exports) != "undefined") {
	exports.Vector = Vector;
	exports.rectRectCollide = rectRectCollide; // Ensure rectRectCollide is exported
	exports.lineRectCollide = lineRectCollide; // Ensure lineRectCollide is exported
}
export { Vector, rectRectCollide, lineRectCollide }; // Ensure rectRectCollide and lineRectCollide are exported